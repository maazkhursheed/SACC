...
export default {
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: Colors.textInverse,
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: Colors.darkBlue,
  tabBarTextSize: 11,
  activeTab: "#fff",
  ...
  // Header
  toolbarBtnColor: "#fff",
  toolbarDefaultBg: Colors.faintWedgeBlue,
  toolbarHeight: 70,
